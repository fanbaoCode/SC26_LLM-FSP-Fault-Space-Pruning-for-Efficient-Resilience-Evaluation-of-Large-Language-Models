...
with open(f"{output_dir}/bart-large_fi_neuron_2bit_prefill_FP32.json", "w", encoding="utf-8") as f:
    json.dump(results, f, indent=4, ensure_ascii=False)

print(f"实验完成。结果保存至 '{output_dir}/bart-large_fi_neuron_2bit_prefill_FP32.json'。")