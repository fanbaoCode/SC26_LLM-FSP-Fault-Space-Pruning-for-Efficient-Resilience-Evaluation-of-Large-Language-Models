...
# 保存结果
output_dir = "./results/t5-3b/lambada"
os.makedirs(output_dir, exist_ok=True)
with open(f"{output_dir}/t5-3b_fi_neuron_2bit_prefill_FP32.json", "w", encoding="utf-8") as f:
    json.dump(results, f, indent=4, ensure_ascii=False)

print(f"实验完成。结果保存至 '{output_dir}/t5-3b_fi_neuron_2bit_prefill_FP32.json'。")